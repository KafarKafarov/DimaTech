...
class PaymentWebhookService:
    ...
    async def process(self, *, payload: PaymentWebhookRequest) -> PaymentWebhookResponse:
        ...
        try:
            await self._account_repository.add_amount(account=account, amount=payload.amount)
    ...
    async def _ensure_account(self, *, payload: PaymentWebhookRequest) -> Account:
        ...
        account = await self._account_repository.get_by_id(account_id=payload.account_id)
